 ...
 * @author cnoye
 */
public class cusprint extends javax.swing.JFrame {

    /**
     * Creates new form cusprint
     */
    public cusprint() {
        initComponents();
    }
    ...
    public cusprint(String sub,String pay,String bal,TableModel tableModel) throws PrinterException {
        initComponents();
        ...
        txtprint.setText(txtprint.getText()+ "************************Tuck Shop*******************\n");
        txtprint.setText(txtprint.getText()+ "\n");
    ...
    private void initComponents() {
        ...
        txtprint.setRows(5);
        txtprint.setPreferredSize(new java.awt.Dimension(450, 390));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cusprint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
